                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <th>@lang('messages.lastname')</th>
                                <th>Email</th>
                                <th>@lang('messages.phoneNumber')</th>
                                <th>@lang('messages.userRole')</th>
                    ...
                    <tr id="item-${id}">
                        <td>
                            <div class="form-group">
                                <input type="text" name="firstname[]" value="" maxlength="255" class="form-control" placeholder="@lang('messages.firstname')..." required />
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                        ...
                        <td>
                            <div class="form-group">
                                <input type="text" name="phonenumber[]" value="" maxlength="30" class="form-control" placeholder="@lang('messages.phoneNumber')..." />
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                        ...
                        <td>
                            <div class="form-group">
                                <input type="password" name="password[]" maxlength="100" minlength="8" value="" class="form-control" placeholder="@lang('messages.password')..." required />
                            </div>
                        </td>
                        <td style="width: 5%;">
